...
namespace AgentMulder.Containers.CastleWindsor.Patterns.FromTypes.BasedOn
{
    public partial class Pick
    {
        public override IEnumerable<FilteredRegistrationBase> GetBasedOnRegistrations(ITreeNode registrationRootElement)
        {
            ...
            if (match.Matched)
            {
                ITypeElement objectTypeElement =
                    TypeFactory.CreateTypeByCLRName("System.Object", registrationRootElement.GetPsiModule(), registrationRootElement.GetResolveContext()).GetTypeElement();
