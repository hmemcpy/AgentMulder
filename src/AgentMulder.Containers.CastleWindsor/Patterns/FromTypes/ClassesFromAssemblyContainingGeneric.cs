...
{
    internal sealed class ClassesFromAssemblyContainingGeneric : ClassesFromAssemblyBasePattern
    {
        ...
        public ClassesFromAssemblyContainingGeneric(params BasedOnRegistrationBasePattern[] basedOnPatterns)
