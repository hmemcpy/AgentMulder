// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RegisterTypeRegistrationProvider.cs" company="Catel & Agent Mulder development teams">
...
namespace AgentMulder.Containers.Catel.Providers
{
    ...
    /// <summary>
    /// The register type registration provider.
    /// </summary>
    [Export]
    [Export(typeof(IRegistrationPatternsProvider))]
    public class RegisterTypeRegistrationProvider : IRegistrationPatternsProvider
    {
